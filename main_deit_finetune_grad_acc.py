...
# from engine_deit_finetune import train_one_epoch, evaluate
from engine_deit_finetune_grad_acc import train_one_epoch, evaluate
...
import my_models.deit_orig_finetune as deit_with_classifier
...
#                        type=str, help='semantic granularity')
    ...
    parser.add_argument('--model_load_path', type=str, default="", help='To load pretrained MSN_model')
...
#    std = IMAGENET_DEFAULT_STD
    ...
    # encoder = deit_with_classifier.__dict__['deit_small']()
    model = deit_with_classifier.__dict__[args.model](pretrained=True, pretrained_21k = True,  img_size=896, model_load_path = args.model_load_path)
    # print("*************pretrained msn imgnet model")
    print("********************************orig deit")
    
    model = interpolate_pos_embed(model, new_size=896)
    model.to(device)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            msn_pretraining=args.msn_pretraining, grad_accum_steps=args.grad_accum_steps
        )
        ...
        # if args.wandb:
        #     run.log({"lr": log_stats["train_lr"], "train_loss": log_stats["train_loss"], "test_loss": log_stats["test_loss"], "test_acc1": log_stats["test_acc1"], "test_acc5": log_stats["test_acc5"] })
